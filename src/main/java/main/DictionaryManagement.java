                    ...
                    if (x != null) {
                        ...
                        switch (actt){
                            case 0 : {
                                ...
                                if((newMeaning != null) && (!newMeaning.isEmpty())) x.setWord_explain(newMeaning);
                            ...
                            case 1 : {
                                ...
                                System.out.println("[CHU Y] Neu ban xoa tat ca cac nghia tieng viet hien co, tu tieng anh do se bi xoa khoi csdl");
